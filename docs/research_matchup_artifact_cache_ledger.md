...
| [31668497497](https://github.com/jeleff1000/league-history-workers/actions/runs/31668497497) | The two smallest blocked sparse playoff/championship artifacts, `9016485043` and `9016453846`, totaling 2,816 source cells. | Inspect its exact team-week-to-player candidate and receipt. If it yields zero candidates, retain the current block with fresh evidence; if it yields candidates, require a separate in-place apply and fresh readback receipt. |
